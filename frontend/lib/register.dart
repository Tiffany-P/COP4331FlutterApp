...
const String apiUrl = 'https://cop4331-27-c6dfafc737d8.herokuapp.com/api/users/register';
...
Future<void> RegisterUser(BuildContext context, String login, String password,
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      String baseUrl = "http://cop4331-27-c6dfafc737d8.herokuapp.com/api/users/verify";
      ...
      content: Text("Registration Successful. Verify email by clicking link in inbox"),
        ));
