              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => SearchPage(id: userId)),
                  );
                },
                child: const Icon(
                  Icons.search,
...
List<BoxInfo> getListInfo(String option) {
  ...
  if (option == 'popular') {
    boxInfoList = [
      ...
      BoxInfo(
          id: '65249b97a5a3366c6ede8721',
          title: 'Mammals',
          description: '',
          color: const Color.fromRGBO(79, 37, 133, 1)),
      BoxInfo(
          id: '65249bf3a5a3366c6ede8723',
          title: 'Sea Life',
          description: '',
          color: const Color.fromRGBO(79, 37, 133, 1)),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => FlashcardPage(
                    quizId: boxInfoList[index].id,
                    name: boxInfoList[index].title,
                    userId: userId,
                  ),
                ),
              );
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: Color.fromARGB(
              200, 155, 141, 18), // Specify the color of the border
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                ...
                //MaterialPageRoute(builder: (context) => SearchScreen()),
                MaterialPageRoute(
                    builder: (context) => savedQuizzesPage(
                          id: userId,
                        )),
              );
            },
