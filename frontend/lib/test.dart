    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Your final score is $score out of ${questions.length}.'),
          actions: [
            TextButton(
              onPressed: () {
                ...
                return Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Color.fromRGBO(48, 60, 84, 1)),
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              primary: quizSubmitted
                                  ? (selectedAnswers[index] == choice
                                      ? (isCorrect ? Color.fromRGBO(76, 175, 80, 1) : Color.fromRGBO(244, 67, 54, 1))
                                      : Color.fromRGBO(92,66,179, 1))
                                  : (selectedAnswers[index] == choice ? Color.fromARGB(255, 126, 113, 170) : Color.fromRGBO(92,66,179, 1)),
                              onPrimary: quizSubmitted ? Colors.white : null,
                            ),
                            child: Text(choice!),
                          ),
                        ),
          ...
          Padding(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: Color.fromRGBO(143, 66, 179, 1)
                ),
